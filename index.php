...
<body>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" >
                        <h2 class="fw-bold text-primary text-uppercase" id="about-us">About Us</h2>
                    </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h2 class="fw-bold text-primary text-uppercase" id = "services">Our Services</h2>
            </div>
            <div class="row g-5">
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase" id="blog">Latest Blog</h5>
    ...
    $body = 'Thank You';
    $stmt = $conn->prepare("INSERT INTO mp_subscription(email) VALUES (?)");
